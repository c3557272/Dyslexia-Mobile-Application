...
/*
This class provides the programming for the fifth page of the first story the user can access.
 */

public class story1p5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story1p5);

        speakButton = findViewById(R.id.voice5);
        article = findViewById(R.id.article5);
    ...
    public void backPage_S1P4(View view) {
        Intent backPageIntents1p4 = new Intent(this, story1p4.class);
        startActivity(backPageIntents1p4);
    }
    ...
    public void nextPage_S1P6(View view) {
        Intent nextPageIntents1p6 = new Intent(this, story1p6.class);
        startActivity(nextPageIntents1p6);
    }
    ...
    public void voice5Click(View view) {
        speak();
    }
