...
/*
This class provides the programming for the third page of the first story the user can access.
 */

public class story1p3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story1p3);

        speakButton = findViewById(R.id.voice3);
        article = findViewById(R.id.article3);
    ...
    public void backPage_S1P2(View view) {
        Intent backPageIntents1p2 = new Intent(this, story1p2.class);
        startActivity(backPageIntents1p2);
    }
    ...
    public void nextPage_S1P4(View view) {
        Intent nextPageIntents1p4 = new Intent(this, story1p4.class);
        startActivity(nextPageIntents1p4);
    }
    ...
    public void voice3Click(View view) {
        speak();
    }
