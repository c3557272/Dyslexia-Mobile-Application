...
/*
This class provides the programming for the fourth page of the first story the user can access.
 */

public class story1p4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story1p4);

        speakButton = findViewById(R.id.voice4);
        article = findViewById(R.id.article4);
    ...
    public void backPage_S1P3(View view) {
        Intent backPageIntents1p3 = new Intent(this, story1p3.class);
        startActivity(backPageIntents1p3);
    }
    ...
    public void nextPage_S1P5(View view) {
        Intent nextPageIntents1p5 = new Intent(this, story1p5.class);
        startActivity(nextPageIntents1p5);
    }
    ...
    public void voice4Click(View view) {
        speak();
    }
