package com.example.dyslexialearningapplication.English.story4;
...
/*
This class provides the programming for the fourth and hardest story the user can access.
 */

public class story4p1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story4p1);

        speakButton = findViewById(R.id.voice13);
        article = findViewById(R.id.article13);
    ...
    public void returnRoot(View view) {
        Intent returnIntent = new Intent(this, chooseStory.class);
    ...
    public void voice13Click(View view) {
        speak();
    }
