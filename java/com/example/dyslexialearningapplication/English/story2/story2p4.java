...
/*
This class provides the programming for the fourth page of the second story the user can access.
 */

public class story2p4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story2p4);

        speakButton = findViewById(R.id.voice10);
        article = findViewById(R.id.article10);
    ...
    public void backPage_S2P3(View view) {
        Intent intentBackPageS2P3 = new Intent(this, story2p3.class);
        startActivity(intentBackPageS2P3);
    }
    ...
    public void returnRoot(View view) {
        Intent returnRootIntent = new Intent(this, chooseStory.class);
    ...
    public void voice10Click(View view) {
        speak();
    }
