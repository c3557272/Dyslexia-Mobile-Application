package com.example.dyslexialearningapplication.English.story2;
...
/*
This class provides the programming for the second page of the second story the user can access.
 */

public class story2p2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story2p2);

        speakButton = findViewById(R.id.voice8);
        article = findViewById(R.id.article8);
    ...
    public void backPage_S2P1(View view) {
        Intent backPageIntentS2P1 = new Intent(this, story2p1.class);
        startActivity(backPageIntentS2P1);
    }
    ...
    public void nextPage_S2P3(View view) {
        Intent nextPageIntentS2P3 = new Intent(this, story2p3.class);
        startActivity(nextPageIntentS2P3);
    }
    ...
    public void voice8Click(View view) {
        speak();
    }
