...
/*
This class provides the programming for the third page of the second story the user can access.
 */

public class story2p3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story2p3);

        speakButton = findViewById(R.id.voice9);
        article = findViewById(R.id.article9);
    ...
    public void backPage_S2P2(View view) {
        Intent backPageIntentS2P2 = new Intent(this, story2p2.class);
        startActivity(backPageIntentS2P2);
    }
    ...
    public void nextPage_S2P4(View view) {
        Intent nextPageIntentS2P4 = new Intent(this, story2p4.class);
        startActivity(nextPageIntentS2P4);
    }
    ...
    public void voice9Click(View view) {
        speak();
    }
