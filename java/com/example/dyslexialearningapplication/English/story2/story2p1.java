...
/*
This class provides the programming for the first page of the second story the user can access.
 */

public class story2p1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story2p1);

        speakButton = findViewById(R.id.voice7);
        article = findViewById(R.id.article7);
    ...
    public void nextPage_S2P2(View view) {
        Intent nextPageIntentS2P2 = new Intent(this, story2p2.class);
        startActivity(nextPageIntentS2P2);
    }
    ...
    public void voice7Click(View view) {
        speak();
    }
