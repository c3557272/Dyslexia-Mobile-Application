...
/*
This class is responsible for requesting the API from the oxford dictionary database.
The code was provided by Oxford to allow access.
 */
...
public class DictionaryRequest extends AsyncTask<String, Integer, String> {
    ...
    //Dictionary method that takes in and sets the context correctly and assigns the TextView to the correct element.
    ...
    protected String doInBackground(String... params) {
        ...
        final String app_id = "09c5bfd8";
        final String app_key = "8ccf71812e0a8c2130f31f961fad6fad";
        try {
    ...
    /*
    This override method of onPostExecute takes in the result as a parameter and executes when the search button has been executed.
     */
