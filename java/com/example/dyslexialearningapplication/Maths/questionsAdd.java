...
public class questionsAdd {
    ...
    public questionsAdd(int higherVal) {
        this.upperLimit = higherVal;
        Random randomNumMaker = new Random();
        this.firstNum = randomNumMaker.nextInt(higherVal);
        this.secondNum = randomNumMaker.nextInt(higherVal);
